...
#define SLHHOOK "LE2StreamingLevelsHUD_"

SPI_PLUGINSIDE_SUPPORT(L"LE2StreamingLevelsHUD", L"Mgamerz", L"3.0.0", SPI_GAME_LE2, SPI_VERSION_LATEST);
...
void SetTextScale()
{
	HWND activeWindow = FindWindowA(NULL, "Mass Effect 2");
	if (activeWindow)
	{
		RECT rcOwner;
